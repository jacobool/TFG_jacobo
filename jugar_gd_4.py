...
class GDEnv(gym.Env):
    def __init__(self):
        ...
        # pygetwindow.activate() lanza falso positivo en Windows
        # (errorCode 0 = "La operacion se completo correctamente").
        # Forzamos foreground via ctypes y silenciamos la excepcion.
        try:
            self.win.activate()
        except Exception:
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"✅ Modelo '{MODEL_PATH}' cargado como {AlgoCls.__name__}.")
