...
def save_plots(history, show=False):
    ...
    plt.tight_layout()
    plt.savefig('metrics_plot_25-3.png', dpi=120)
...
if __name__ == "__main__":
    ...
    save_callback = MetricsAndSaveCallback(save_freq=SAVE_FREQ, save_path="modelos_guardados/gd_dqn_4")
