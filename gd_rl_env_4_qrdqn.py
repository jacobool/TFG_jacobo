...
def save_plots(history, run_name, show=False):
    ...
    panels = [
        ...
        ("rollout/exploration_rate", "Epsilon (exploración)", "tab:purple"),
    ]
...
if __name__ == "__main__":
    ...
    # QR-DQN: DQN distribucional (200 cuantiles por defecto).
    # Hiperparámetros alineados con el DQN actual para comparar justo.
    model = QRDQN(
        "CnnPolicy",
        env,
        verbose=0,
    ...
    print(f"🚀 Entrenamiento QR-DQN — {TOTAL_TIMESTEPS} pasos, guardado cada {SAVE_FREQ}.")
