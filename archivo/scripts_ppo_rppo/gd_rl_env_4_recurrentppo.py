...
if __name__ == "__main__":
    ...
    # Sin VecFrameStack: el LSTM del policy se encarga de la memoria temporal.
    ...
    callback = MetricsAndSaveCallback(
        ...
        run_name=RUN_NAME,
        log_keys=RPPO_LOG_KEYS,
    )

    # RecurrentPPO con CnnLstmPolicy: CNN + LSTM de 128 unidades.
    # n_steps=64, batch_size=64 (múltiplo del rollout). Hiperparámetros estilo Atari.
    model = RecurrentPPO(
        "CnnLstmPolicy",
        env,
        verbose=0,
    ...
    print(f"🚀 Entrenamiento RecurrentPPO — {TOTAL_TIMESTEPS} pasos, guardado cada {SAVE_FREQ}.")
