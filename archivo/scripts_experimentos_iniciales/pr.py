...
DEATH_FRAMES_NEEDED = 5  # Frames consecutivos sin verde para confirmar muerte (~0.2s a 30fps)
STEP_DURATION = 1 / 30   # Duración fija de cada step (30fps)
MIN_EPISODE_GAP = 1.5
...
def save_plots(history, show=False):
    ...
    plt.tight_layout()
    plt.savefig('METRICAS_10-3.png', dpi=120)
...
class MetricsAndSaveCallback(BaseCallback):
    def __init__(self, save_freq, save_path, verbose=0):
        ...
        self.ep_reward = 0.0
        self.ep_start_time = time.time()  # time.time() correcto aquí — mide segundos reales
...
if __name__ == "__main__":
    ...
    print(f"⚠️  Se realizarán 150,000 pasos. Guardado automático cada {SAVE_FREQ} pasos.")
