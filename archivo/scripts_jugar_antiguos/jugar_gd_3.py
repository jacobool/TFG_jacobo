...
class GDEnv(gym.Env):
    ...
    def _get_obs(self, frame_gray_cropped, original_width, bbox_abs):
        ...
        return np.expand_dims(cv2.resize(vision_clean, (84, 84)), axis=-1).astype(np.uint8)
...
if __name__ == "__main__":
    ...
    try:
        model = DQN.load("models/gd_dqn_FINAL_3", env=env)
        print("✅ Modelo 'gd_dqn_FINAL_3' cargado con éxito.")
