...
def save_plots(history, show=False):
    ...
    plt.tight_layout()
    plt.savefig('metrics_plot_21-3.png', dpi=120)
...
class GDEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action == 1 and (now - self.last_action_time > 0.05):
            ...
            reward -= 0.02  # Penalización mínima por saltar
    ...
    def _get_obs(self, frame_gray_cropped, original_width, bbox_abs):
        ...
        # Redimensionamos a 84x84
        resized = cv2.resize(vision_clean, (84, 84))
...
if __name__ == "__main__":
    ...
    save_callback = MetricsAndSaveCallback(save_freq=SAVE_FREQ, save_path="modelos_guardados/gd_dqn_3")
